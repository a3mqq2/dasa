...
<title>@yield('title', 'Dasa\'s Cake')</title>
{{-- [Meta] --}}
<meta charset="utf-8" />
<meta
  name="viewport"
...
<meta
  name="keywords"
  content="Dasa's Cake, التخاطب, تنمية المهارات, التعليم, التدريب"
/>
  ...
  <div class="navbar-wrapper">
    <div class="m-header">
      <a href="{{ route('sections') }}" class="b-brand text-primary">
        {{-- <img src="{{ asset('assets/images/logo-white.png') }}" class="logo" width="200" alt=""> --}}
      </a>
    </div>
        ...
        <div class="card-body">
          <div class="d-flex align-items-center">
            <div class="flex-shrink-0">
              <img alt="user-image" class="user-avtar wid-45 rounded-circle" src="{{ asset('https://ui-avatars.com/api/?name=' . implode('+', explode(' ', Auth::user()->name)) . '&background=f5476b&color=fff') }}">
            </div>
...
<footer class="pc-footer">
  <div class="footer-wrapper container-fluid">
    <div class="row">
      <div class="col my-1">
        <p class="m-0">
          جميع الحقوق محفوظة. Dasa's Cake 
        </p>
      </div>
    </div>
  </div>
