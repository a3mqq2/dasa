...
<style>
    ...
    .page-header::before {
        ...
        width: 60px;
        height: 2px;
        background: linear-gradient(90deg, transparent, #f5476b, transparent);
        border-radius: 1px;
    }
    ...
    .role-icon {
        width: 55px;
        height: 55px;
        background: linear-gradient(135deg, #f5476b 0%, #429bff 100%);
        border-radius: 50%;
        display: flex;
        align-items: center;
        justify-content: center;
...
<div class="roles-container">
   ...
   <div class="head-page">
      <h3 style="font-weight: bold;color: #f5476b;">مرحباً بعودتك {{ auth()->user()->name }}</h3>
